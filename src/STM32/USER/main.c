...
int main(void)
{
	...
	u8g2Ui_text_t *u8g2Ui_text = new_u8g2Ui_text(u8g2Ui_paintingFrame2, "Hello");

	u8g2Ui_setPosSize_w(u8g2Ui_paintingFrame, 128);
	u8g2Ui_setPosSize_h(u8g2Ui_paintingFrame, 64);
	u8g2Ui_setPosSize_w(u8g2Ui_paintingFrame2, 64);
	u8g2Ui_setPosSize_h(u8g2Ui_paintingFrame2, 20);
	u8g2Ui_setPosSize_x(u8g2Ui_text, 1);
	u8g2Ui_setPosSize_y(u8g2Ui_text, 1);
