...
u8g2_menu_t *u8g2_MenuItemValue(MENU_Attribute_t MENU_Attribute)
{
	u8g2_menu_t *menu = u8g2_MenuGetCurrentMenu();
	if (!menu)
		return NULL;
...
{
	u8g2_menu_t *menu = u8g2_MenuItemValue(MENU_Writable);
	if (!menu)
		return;
...
{
	u8g2_menu_t *menu = u8g2_MenuItemValue(MENU_Fix);
	if (!menu)
		return;
